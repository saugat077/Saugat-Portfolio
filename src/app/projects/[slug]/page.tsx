    ...
    <>
      ...
      <main className="max-w-190 mx-auto px-6 xl:px-0 pt-22 sm:pt-28 pb-24">
        ...
        <nav className="flex items-center gap-2 mb-6 text-label" aria-label="Breadcrumb">
          ...
          <Link href="/projects" className="press focusable tap text-zinc-400 hover:text-white">
            Projects
          </Link>
          <span className="text-quiet" aria-hidden="true">/</span>
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-8">
          {/* Left: screenshot (60%) */}
          {screenshotUrl && (
            <div className="md:w-[60%] shrink-0 rounded-2xl overflow-hidden bg-zinc-900 self-start">
              ...
              <div className="flex items-center gap-2">
                {githubUrl && (
                  <a
                    ...
                    className="press focusable tap inline-flex gap-1.5 text-label text-zinc-400 border border-zinc-500 rounded-full px-3 py-1 hover:border-accent-soft/40 hover:text-accent-soft"
                  >
        ...
        {bodyHtml ? (
          ...
          <p className="text-body text-zinc-400 italic">Write-up coming soon.</p>
        )}
